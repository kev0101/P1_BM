...
<body>
    <!-- Pagina Inicio -->
    <!--Pagina KOLBI-->
    <div data-role="page" data-theme="b" id="PaginaPagosAcueductos">
        ...
        <div data-role="main" class="ui-content">
            <div align="center">
                <img id="image2" width="100%" heigth="100%" src="../Img/AYA.png">
        ...
        <div data-role="footer">
            <div data-role="navbar">
                <ul>
                    ...
                    <li><a href="#PaginaPagosAcueductos" data-transition="fade">Cancelar</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div data-role="page" data-dialog="true" id="ALERT2">
        ...
        <div data-role="footer">
            <div data-role="navbar">
                <ul>
                    <li><a href="#PaginaPagosAcueductos" data-transition="fade">OK</a></li>
                </ul>
            </div>
        </div>
    </div>
